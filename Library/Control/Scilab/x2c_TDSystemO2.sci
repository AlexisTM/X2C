// This file was generated by createIFunction.sci on 03-03-2017 01:18

function [x_sci,y_sci,typ_sci] = x2c_TDSystemO2(job, arg1, arg2)

thisBlockData.Library = "Control"
thisBlockData.block_type_name = "TDSystemO2"
thisBlockData.block_xcosfilename = "x2c_TDSystemO2"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TDSystemO2_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=x<sub>k+1</sub> = A x<sub>k</sub> + B u<sub>k</sub><br>y<sub>k &nbsp &nbsp </sub> = C x<sub>k</sub>";
x_sci.graphics.in_style = ["textOpacity=0";"textOpacity=0"];
x_sci.graphics.out_style = ["textOpacity=0";"textOpacity=0"];
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TDSystemO2_"  + impl + "_C", 4);
