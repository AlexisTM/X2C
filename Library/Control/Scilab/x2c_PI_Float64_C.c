...
/* */
void x2c_PI_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_PI_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_PI_Float64_C__StateUpdate(scicos_block* block);
static void x2c_PI_Float64_C__Initialization(scicos_block* block);
static void x2c_PI_Float64_C__Ending(scicos_block* block);
...
void x2c_PI_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_PI_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_PI_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_PI_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_PI_Float64_C__Ending(block);
            break;
        }
...
static void x2c_PI_Float64_C__set_parameter(scicos_block* block, PI_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    PI_FLOAT64 *pTPI_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTPI_Float64 = GetWorkPtrs(block);
...
static void x2c_PI_Float64_C__Ending(scicos_block* block) {
    PI_FLOAT64 *pTPI_Float64;
    pTPI_Float64 = GetWorkPtrs(block);
    scicos_free(pTPI_Float64);
}


static void x2c_PI_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_PI_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_PI_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_PI_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    PI_Float64_Update(pTPI_Float64);
