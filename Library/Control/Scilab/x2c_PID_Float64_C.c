...
/* */
void x2c_PID_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_PID_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_PID_Float64_C__StateUpdate(scicos_block* block);
static void x2c_PID_Float64_C__Initialization(scicos_block* block);
static void x2c_PID_Float64_C__Ending(scicos_block* block);
...
void x2c_PID_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_PID_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_PID_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_PID_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_PID_Float64_C__Ending(block);
            break;
        }
...
static void x2c_PID_Float64_C__set_parameter(scicos_block* block, PID_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    PID_FLOAT64 *pTPID_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTPID_Float64 = GetWorkPtrs(block);
...
static void x2c_PID_Float64_C__Ending(scicos_block* block) {
    PID_FLOAT64 *pTPID_Float64;
    pTPID_Float64 = GetWorkPtrs(block);
    scicos_free(pTPID_Float64);
}


static void x2c_PID_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_PID_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_PID_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_PID_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    PID_Float64_Update(pTPID_Float64);
