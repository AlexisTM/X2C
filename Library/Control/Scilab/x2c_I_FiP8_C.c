...
/* */
void x2c_I_FiP8_C(scicos_block* block, scicos_flag flag);
static void x2c_I_FiP8_C__OutputUpdate(scicos_block* block);
static void x2c_I_FiP8_C__StateUpdate(scicos_block* block);
static void x2c_I_FiP8_C__Initialization(scicos_block* block);
static void x2c_I_FiP8_C__Ending(scicos_block* block);
...
void x2c_I_FiP8_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_I_FiP8_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_I_FiP8_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_I_FiP8_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_I_FiP8_C__Ending(block);
            break;
        }
...
static void x2c_I_FiP8_C__set_parameter(scicos_block* block, I_FIP8 *blockParam) {
    int *paramI;
    double *paramR;
    I_FIP8 *pTI_FiP8;
...
static void x2c_I_FiP8_C__Ending(scicos_block* block) {
    I_FIP8 *pTI_FiP8;
    pTI_FiP8 = GetWorkPtrs(block);
    scicos_free(pTI_FiP8);
}


static void x2c_I_FiP8_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_I_FiP8_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_I_FiP8_C__StateUpdate_f(block);
    }
}
