...
/* */
void x2c_PT1_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_PT1_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_PT1_Float64_C__StateUpdate(scicos_block* block);
static void x2c_PT1_Float64_C__Initialization(scicos_block* block);
static void x2c_PT1_Float64_C__Ending(scicos_block* block);
...
void x2c_PT1_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_PT1_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_PT1_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_PT1_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_PT1_Float64_C__Ending(block);
            break;
        }
...
static void x2c_PT1_Float64_C__set_parameter(scicos_block* block, PT1_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    PT1_FLOAT64 *pTPT1_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTPT1_Float64 = GetWorkPtrs(block);
    blockParam->b0 = (float64)paramR[0];
    blockParam->b1 = (float64)paramR[1];
    blockParam->a0 = (float64)paramR[2];
}
...
static void x2c_PT1_Float64_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTPT1_Float64 = scicos_malloc(sizeof(PT1_FLOAT64));
    GetWorkPtrs(block) = pTPT1_Float64;
    x2c_PT1_Float64_C__set_parameter(block, pTPT1_Float64);

    /* Assignment of inports */
    inport_In_p = GetInPortPtrs(block, 1);
    inport_In = convert_double_to_float64(*inport_In_p);
    pTPT1_Float64->In = &inport_In;

    /* Assignment of parameter arrays */

    /* Initialization */
    PT1_Float64_Init(pTPT1_Float64);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float64_to_double(pTPT1_Float64->Out);
}
...
static void x2c_PT1_Float64_C__Ending(scicos_block* block) {
    PT1_FLOAT64 *pTPT1_Float64;
    pTPT1_Float64 = GetWorkPtrs(block);
    scicos_free(pTPT1_Float64);
}


static void x2c_PT1_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_PT1_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_PT1_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_PT1_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    PT1_Float64_Update(pTPT1_Float64);
