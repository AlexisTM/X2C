...
function [x_sci,y_sci,typ_sci] = x2c_TF1(job, arg1, arg2)

thisBlockData.Library = "Control"
thisBlockData.block_type_name = "TF1"
thisBlockData.block_xcosfilename = "x2c_TF1"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TF1_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=b<sub>1</sub>z + b<sub>0</sub><br>-----------<br>&nbsp<sub>&nbsp</sub>z + a<sub>0</sub>";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TF1_"  + impl + "_C", 4);
