...
function [x_sci,y_sci,typ_sci] = x2c_TDSystemO1(job, arg1, arg2)

thisBlockData.Library = "Control"
thisBlockData.block_type_name = "TDSystemO1"
thisBlockData.block_xcosfilename = "x2c_TDSystemO1"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TDSystemO1_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=x<sub>k+1</sub> = A x<sub>k</sub> + B u<sub>k</sub><br>y<sub>k &nbsp &nbsp </sub> = C x<sub>k</sub> + D u<sub>k</sub>";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TDSystemO1_"  + impl + "_C", 4);
