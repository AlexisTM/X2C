...
function [x_sci,y_sci,typ_sci] = x2c_Delay(job, arg1, arg2)

thisBlockData.Library = "Control"
thisBlockData.block_type_name = "Delay"
thisBlockData.block_xcosfilename = "x2c_Delay"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Delay_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=<sup>1</sup>&frasl <sub>z</sub>";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Delay_"  + impl + "_C", 4);
