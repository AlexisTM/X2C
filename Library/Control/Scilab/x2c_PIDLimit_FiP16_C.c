...
/* */
void x2c_PIDLimit_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_PIDLimit_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_PIDLimit_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_PIDLimit_FiP16_C__Initialization(scicos_block* block);
static void x2c_PIDLimit_FiP16_C__Ending(scicos_block* block);
...
void x2c_PIDLimit_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_PIDLimit_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_PIDLimit_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_PIDLimit_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_PIDLimit_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_PIDLimit_FiP16_C__set_parameter(scicos_block* block, PIDLIMIT_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    PIDLIMIT_FIP16 *pTPIDLimit_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTPIDLimit_FiP16 = GetWorkPtrs(block);
    blockParam->b0 = (int16)paramI[0];
    blockParam->b1 = (int16)paramI[1];
    blockParam->b0d = (int16)paramI[2];
    blockParam->b1d = (int16)paramI[3];
    blockParam->a0d = (int16)paramI[4];
...
static void x2c_PIDLimit_FiP16_C__Ending(scicos_block* block) {
    PIDLIMIT_FIP16 *pTPIDLimit_FiP16;
    pTPIDLimit_FiP16 = GetWorkPtrs(block);
    scicos_free(pTPIDLimit_FiP16);
}


static void x2c_PIDLimit_FiP16_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_PIDLimit_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_PIDLimit_FiP16_C__StateUpdate_f(block);
    }
}
...
static void x2c_PIDLimit_FiP16_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    PIDLimit_FiP16_Update(pTPIDLimit_FiP16);
