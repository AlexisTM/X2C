...
function [x_sci,y_sci,typ_sci] = x2c_Sin2Limiter(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Sin2Limiter"
thisBlockData.block_xcosfilename = "x2c_Sin2Limiter"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Sin2Limiter_"  + impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Sin2Limiter_"  + impl + "_C", 4);
