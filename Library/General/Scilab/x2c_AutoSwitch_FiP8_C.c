...
/* */
void x2c_AutoSwitch_FiP8_C(scicos_block* block, scicos_flag flag);
static void x2c_AutoSwitch_FiP8_C__OutputUpdate(scicos_block* block);
static void x2c_AutoSwitch_FiP8_C__StateUpdate(scicos_block* block);
static void x2c_AutoSwitch_FiP8_C__Initialization(scicos_block* block);
static void x2c_AutoSwitch_FiP8_C__Ending(scicos_block* block);
...
void x2c_AutoSwitch_FiP8_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_AutoSwitch_FiP8_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_AutoSwitch_FiP8_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_AutoSwitch_FiP8_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_AutoSwitch_FiP8_C__Ending(block);
            break;
        }
...
static void x2c_AutoSwitch_FiP8_C__set_parameter(scicos_block* block, AUTOSWITCH_FIP8 *blockParam) {
    int *paramI;
    double *paramR;
    AUTOSWITCH_FIP8 *pTAutoSwitch_FiP8;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTAutoSwitch_FiP8 = GetWorkPtrs(block);
    blockParam->Thresh_up = (int8)paramI[0];
    blockParam->Thresh_down = (int8)paramI[1];
}
...
static void x2c_AutoSwitch_FiP8_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTAutoSwitch_FiP8 = scicos_malloc(sizeof(AUTOSWITCH_FIP8));
    GetWorkPtrs(block) = pTAutoSwitch_FiP8;
    x2c_AutoSwitch_FiP8_C__set_parameter(block, pTAutoSwitch_FiP8);

    /* Assignment of inports */
    inport_In1_p = GetInPortPtrs(block, 1);
    inport_In1 = convert_double_to_Q7(*inport_In1_p);
    pTAutoSwitch_FiP8->In1 = &inport_In1;
    inport_Switch_p = GetInPortPtrs(block, 2);
    inport_Switch = convert_double_to_Q7(*inport_Switch_p);
    pTAutoSwitch_FiP8->Switch = &inport_Switch;
    inport_In3_p = GetInPortPtrs(block, 3);
    inport_In3 = convert_double_to_Q7(*inport_In3_p);
    pTAutoSwitch_FiP8->In3 = &inport_In3;

    /* Assignment of parameter arrays */

    /* Initialization */
    AutoSwitch_FiP8_Init(pTAutoSwitch_FiP8);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_Q7_to_double(pTAutoSwitch_FiP8->Out);
}
...
static void x2c_AutoSwitch_FiP8_C__Ending(scicos_block* block) {
    AUTOSWITCH_FIP8 *pTAutoSwitch_FiP8;
    pTAutoSwitch_FiP8 = GetWorkPtrs(block);
    scicos_free(pTAutoSwitch_FiP8);
}


static void x2c_AutoSwitch_FiP8_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_AutoSwitch_FiP8_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_AutoSwitch_FiP8_C__StateUpdate_f(block);
    }
}
...
static void x2c_AutoSwitch_FiP8_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    AutoSwitch_FiP8_Update(pTAutoSwitch_FiP8);
