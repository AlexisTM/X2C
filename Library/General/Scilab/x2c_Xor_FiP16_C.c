...
/* */
void x2c_Xor_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_Xor_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_Xor_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_Xor_FiP16_C__Initialization(scicos_block* block);
static void x2c_Xor_FiP16_C__Ending(scicos_block* block);
...
void x2c_Xor_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Xor_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Xor_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Xor_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Xor_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_Xor_FiP16_C__set_parameter(scicos_block* block, XOR_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    XOR_FIP16 *pTXor_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTXor_FiP16 = GetWorkPtrs(block);
}
...
static void x2c_Xor_FiP16_C__Ending(scicos_block* block) {
    XOR_FIP16 *pTXor_FiP16;
    pTXor_FiP16 = GetWorkPtrs(block);
    scicos_free(pTXor_FiP16);
}


static void x2c_Xor_FiP16_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Xor_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Xor_FiP16_C__StateUpdate_f(block);
    }
}
