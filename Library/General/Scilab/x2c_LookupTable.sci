...
function [x_sci,y_sci,typ_sci] = x2c_LookupTable(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "LookupTable"
thisBlockData.block_xcosfilename = "x2c_LookupTable"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_LookupTable_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=lookup(u)";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_LookupTable_"  + impl + "_C", 4);
