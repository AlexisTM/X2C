...
/* */
void x2c_uConstant_FiP8_C(scicos_block* block, scicos_flag flag);
static void x2c_uConstant_FiP8_C__OutputUpdate(scicos_block* block);
static void x2c_uConstant_FiP8_C__StateUpdate(scicos_block* block);
static void x2c_uConstant_FiP8_C__Initialization(scicos_block* block);
static void x2c_uConstant_FiP8_C__Ending(scicos_block* block);
...
void x2c_uConstant_FiP8_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_uConstant_FiP8_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_uConstant_FiP8_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_uConstant_FiP8_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_uConstant_FiP8_C__Ending(block);
            break;
        }
...
static void x2c_uConstant_FiP8_C__set_parameter(scicos_block* block, UCONSTANT_FIP8 *blockParam) {
    int *paramI;
    double *paramR;
    UCONSTANT_FIP8 *pTuConstant_FiP8;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTuConstant_FiP8 = GetWorkPtrs(block);
...
static void x2c_uConstant_FiP8_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTuConstant_FiP8 = scicos_malloc(sizeof(UCONSTANT_FIP8));
    GetWorkPtrs(block) = pTuConstant_FiP8;
    x2c_uConstant_FiP8_C__set_parameter(block, pTuConstant_FiP8);
    ...
    /* Initialization */
    uConstant_FiP8_Init(pTuConstant_FiP8);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_Q7_to_double(pTuConstant_FiP8->Out);
}
...
static void x2c_uConstant_FiP8_C__Ending(scicos_block* block) {
    UCONSTANT_FIP8 *pTuConstant_FiP8;
    pTuConstant_FiP8 = GetWorkPtrs(block);
    scicos_free(pTuConstant_FiP8);
}


static void x2c_uConstant_FiP8_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_uConstant_FiP8_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_uConstant_FiP8_C__StateUpdate_f(block);
    }
}
