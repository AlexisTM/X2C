...
function [x_sci,y_sci,typ_sci] = x2c_Sequencer(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Sequencer"
thisBlockData.block_xcosfilename = "x2c_Sequencer"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Sequencer_"  + impl + "_C", 4);
...
x_sci.graphics.out_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";]
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Sequencer_"  + impl + "_C", 4);
