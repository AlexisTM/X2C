...
function [x_sci,y_sci,typ_sci] = x2c_uSaveSignal(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "uSaveSignal"
thisBlockData.block_xcosfilename = "x2c_uSaveSignal"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_uSaveSignal_"  + impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_uSaveSignal_"  + impl + "_C", 4);
