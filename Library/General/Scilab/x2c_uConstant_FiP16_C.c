...
/* */
void x2c_uConstant_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_uConstant_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_uConstant_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_uConstant_FiP16_C__Initialization(scicos_block* block);
static void x2c_uConstant_FiP16_C__Ending(scicos_block* block);
...
void x2c_uConstant_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_uConstant_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_uConstant_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_uConstant_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_uConstant_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_uConstant_FiP16_C__set_parameter(scicos_block* block, UCONSTANT_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    UCONSTANT_FIP16 *pTuConstant_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTuConstant_FiP16 = GetWorkPtrs(block);
    blockParam->K = (int16)paramI[0];
}
...
static void x2c_uConstant_FiP16_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTuConstant_FiP16 = scicos_malloc(sizeof(UCONSTANT_FIP16));
    GetWorkPtrs(block) = pTuConstant_FiP16;
    x2c_uConstant_FiP16_C__set_parameter(block, pTuConstant_FiP16);
    ...
    /* Initialization */
    uConstant_FiP16_Init(pTuConstant_FiP16);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_Q15_to_double(pTuConstant_FiP16->Out);
}
...
static void x2c_uConstant_FiP16_C__Ending(scicos_block* block) {
    UCONSTANT_FIP16 *pTuConstant_FiP16;
    pTuConstant_FiP16 = GetWorkPtrs(block);
    scicos_free(pTuConstant_FiP16);
}


static void x2c_uConstant_FiP16_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_uConstant_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_uConstant_FiP16_C__StateUpdate_f(block);
    }
}
