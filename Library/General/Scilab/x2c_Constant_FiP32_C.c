...
/* */
void x2c_Constant_FiP32_C(scicos_block* block, scicos_flag flag);
static void x2c_Constant_FiP32_C__OutputUpdate(scicos_block* block);
static void x2c_Constant_FiP32_C__StateUpdate(scicos_block* block);
static void x2c_Constant_FiP32_C__Initialization(scicos_block* block);
static void x2c_Constant_FiP32_C__Ending(scicos_block* block);
...
void x2c_Constant_FiP32_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Constant_FiP32_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Constant_FiP32_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Constant_FiP32_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Constant_FiP32_C__Ending(block);
            break;
        }
...
static void x2c_Constant_FiP32_C__set_parameter(scicos_block* block, CONSTANT_FIP32 *blockParam) {
    int *paramI;
    double *paramR;
    CONSTANT_FIP32 *pTConstant_FiP32;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTConstant_FiP32 = GetWorkPtrs(block);
...
static void x2c_Constant_FiP32_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTConstant_FiP32 = scicos_malloc(sizeof(CONSTANT_FIP32));
    GetWorkPtrs(block) = pTConstant_FiP32;
    x2c_Constant_FiP32_C__set_parameter(block, pTConstant_FiP32);
    ...
    /* Initialization */
    Constant_FiP32_Init(pTConstant_FiP32);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_Q31_to_double(pTConstant_FiP32->Out);
}
...
static void x2c_Constant_FiP32_C__Ending(scicos_block* block) {
    CONSTANT_FIP32 *pTConstant_FiP32;
    pTConstant_FiP32 = GetWorkPtrs(block);
    scicos_free(pTConstant_FiP32);
}


static void x2c_Constant_FiP32_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Constant_FiP32_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Constant_FiP32_C__StateUpdate_f(block);
    }
}
