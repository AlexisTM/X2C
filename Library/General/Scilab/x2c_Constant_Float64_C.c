...
/* */
void x2c_Constant_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_Constant_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_Constant_Float64_C__StateUpdate(scicos_block* block);
static void x2c_Constant_Float64_C__Initialization(scicos_block* block);
static void x2c_Constant_Float64_C__Ending(scicos_block* block);
...
void x2c_Constant_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Constant_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Constant_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Constant_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Constant_Float64_C__Ending(block);
            break;
        }
...
static void x2c_Constant_Float64_C__set_parameter(scicos_block* block, CONSTANT_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    CONSTANT_FLOAT64 *pTConstant_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTConstant_Float64 = GetWorkPtrs(block);
...
static void x2c_Constant_Float64_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTConstant_Float64 = scicos_malloc(sizeof(CONSTANT_FLOAT64));
    GetWorkPtrs(block) = pTConstant_Float64;
    x2c_Constant_Float64_C__set_parameter(block, pTConstant_Float64);
    ...
    /* Initialization */
    Constant_Float64_Init(pTConstant_Float64);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float64_to_double(pTConstant_Float64->Out);
}
...
static void x2c_Constant_Float64_C__Ending(scicos_block* block) {
    CONSTANT_FLOAT64 *pTConstant_Float64;
    pTConstant_Float64 = GetWorkPtrs(block);
    scicos_free(pTConstant_Float64);
}


static void x2c_Constant_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Constant_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Constant_Float64_C__StateUpdate_f(block);
    }
}
