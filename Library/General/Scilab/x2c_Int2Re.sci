...
function [x_sci,y_sci,typ_sci] = x2c_Int2Re(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Int2Real"
thisBlockData.block_xcosfilename = "x2c_Int2Re"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Int2Re_"  + impl + "_C", 4);
...
impl = exprs(7);
if ~strcmp(impl,"FiP8_Float32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i8 &#8594 f32";
elseif ~strcmp(impl,"FiP16_Float32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i16 &#8594 f32";
elseif ~strcmp(impl,"FiP32_Float32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i32 &#8594 f32";
elseif ~strcmp(impl,"FiP8_Float64") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i8 &#8594 f64";
elseif ~strcmp(impl,"FiP16_Float64") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i16 &#8594 f64";
elseif ~strcmp(impl,"FiP32_Float64") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i32 &#8594 f64";
else
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Int2Re_"  + impl + "_C", 4);
