...
function [x_sci,y_sci,typ_sci] = x2c_Real2I(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Real2Int"
thisBlockData.block_xcosfilename = "x2c_Real2I"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Real2I_"  + impl + "_C", 4);
...
impl = exprs(7);
if ~strcmp(impl,"Float32_FiP8") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f32 &#8594 i8";
elseif ~strcmp(impl,"Float32_FiP16") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f32 &#8594 i16";
elseif ~strcmp(impl,"Float32_FiP32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f32 &#8594 i32";
elseif ~strcmp(impl,"Float64_FiP8") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f64 &#8594 i8";
elseif ~strcmp(impl,"Float64_FiP16") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f64 &#8594 i16";
elseif ~strcmp(impl,"Float64_FiP32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=f64 &#8594 i32";
else
    x_sci.graphics.style = "noLabel=0;displayedLabel=? &#8594 ?";
end
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Real2I_"  + impl + "_C", 4);
