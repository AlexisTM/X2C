...
function [x_sci,y_sci,typ_sci] = x2c_Outport(job, arg1, arg2)
...
thisBlockData.block_type_name = "Outport";
thisBlockData.block_xcosfilename = "x2c_Outport";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Outport_"  + impl + "_C", 4);
...
case "define" then
    ...
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Outport_"  + impl + "_C", 4);
    model.in = 1;
    model.evtin = [1];
    model.out = 1;
