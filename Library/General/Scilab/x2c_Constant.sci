...
function [x_sci,y_sci,typ_sci] = x2c_Constant(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Constant"
thisBlockData.block_xcosfilename = "x2c_Constant"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Constant_"  + impl + "_C", 4);
...
val = exprs(11);
if ~strcmp(val,"")
    x_sci.graphics.style = "noLabel=0;displayedLabel=%10$s";
elseif ~strcmp(spin,"")
    x_sci.graphics.style = "noLabel=0;displayedLabel=" + string(evstr(val));
else
    x_sci.graphics.style = "noLabel=0;displayedLabel=%10$s";
end
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Constant_"  + impl + "_C", 4);
