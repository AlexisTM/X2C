...
function [x_sci,y_sci,typ_sci] = x2c_RateLimiter(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "RateLimiter"
thisBlockData.block_xcosfilename = "x2c_RateLimiter"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_RateLimiter_"  + impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_RateLimiter_"  + impl + "_C", 4);
