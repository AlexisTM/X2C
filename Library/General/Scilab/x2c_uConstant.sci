...
function [x_sci,y_sci,typ_sci] = x2c_uConstant(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "uConstant"
thisBlockData.block_xcosfilename = "x2c_uConstant"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_uConstant_"  + impl + "_C", 4);
...
elseif ~strcmp(spin,"")
    x_sci.graphics.style = "noLabel=0;displayedLabel=%11$s";
else
    x_sci.graphics.style = "noLabel=0;displayedLabel=%10$s";
end
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_uConstant_"  + impl + "_C", 4);
