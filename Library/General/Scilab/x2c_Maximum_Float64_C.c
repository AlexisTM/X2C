...
/* */
void x2c_Maximum_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_Maximum_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_Maximum_Float64_C__StateUpdate(scicos_block* block);
static void x2c_Maximum_Float64_C__Initialization(scicos_block* block);
static void x2c_Maximum_Float64_C__Ending(scicos_block* block);
...
void x2c_Maximum_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Maximum_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Maximum_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Maximum_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Maximum_Float64_C__Ending(block);
            break;
        }
...
static void x2c_Maximum_Float64_C__set_parameter(scicos_block* block, MAXIMUM_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    MAXIMUM_FLOAT64 *pTMaximum_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTMaximum_Float64 = GetWorkPtrs(block);
}
...
static void x2c_Maximum_Float64_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTMaximum_Float64 = scicos_malloc(sizeof(MAXIMUM_FLOAT64));
    GetWorkPtrs(block) = pTMaximum_Float64;
    x2c_Maximum_Float64_C__set_parameter(block, pTMaximum_Float64);

    /* Assignment of inports */
    inport_In1_p = GetInPortPtrs(block, 1);
    inport_In1 = convert_double_to_float64(*inport_In1_p);
    pTMaximum_Float64->In1 = &inport_In1;
    inport_In2_p = GetInPortPtrs(block, 2);
    inport_In2 = convert_double_to_float64(*inport_In2_p);
    pTMaximum_Float64->In2 = &inport_In2;

    /* Assignment of parameter arrays */

    /* Initialization */
    Maximum_Float64_Init(pTMaximum_Float64);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float64_to_double(pTMaximum_Float64->Out);
}
...
static void x2c_Maximum_Float64_C__Ending(scicos_block* block) {
    MAXIMUM_FLOAT64 *pTMaximum_Float64;
    pTMaximum_Float64 = GetWorkPtrs(block);
    scicos_free(pTMaximum_Float64);
}


static void x2c_Maximum_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Maximum_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Maximum_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_Maximum_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    Maximum_Float64_Update(pTMaximum_Float64);
