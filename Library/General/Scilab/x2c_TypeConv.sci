...
function [x_sci,y_sci,typ_sci] = x2c_TypeConv(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "TypeConv"
thisBlockData.block_xcosfilename = "x2c_TypeConv"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TypeConv_"  + impl + "_C", 4);
...
impl = exprs(7);
if ~strcmp(impl,"FiP8_16") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i8 &#8594 i16";
elseif ~strcmp(impl,"FiP8_32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i8 &#8594 i32";
elseif ~strcmp(impl,"FiP16_8") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i16 &#8594 i8";
elseif ~strcmp(impl,"FiP16_32") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i16 &#8594 i32";
elseif ~strcmp(impl,"FiP32_8") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i32 &#8594 i8";
elseif ~strcmp(impl,"FiP32_16") then
    x_sci.graphics.style = "noLabel=0;displayedLabel=i32 &#8594 i16";
else
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TypeConv_"  + impl + "_C", 4);
