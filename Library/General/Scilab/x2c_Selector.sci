...
function [x_sci,y_sci,typ_sci] = x2c_Selector(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "Selector"
thisBlockData.block_xcosfilename = "x2c_Selector"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Selector_"  + impl + "_C", 4);
...
x_sci.graphics.in_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";];
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Selector_"  + impl + "_C", 4);
