...
function [x_sci,y_sci,typ_sci] = x2c_ManualSwitch(job, arg1, arg2)

thisBlockData.Library = "General"
thisBlockData.block_type_name = "ManualSwitch"
thisBlockData.block_xcosfilename = "x2c_ManualSwitch"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_ManualSwitch_"  + impl + "_C", 4);
...
if ~strcmp(val,"")
	if strtod(spin) <> 0
		x_sci.graphics.style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch1.svg";
	else
		x_sci.graphics.style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch0.svg";	
	end
elseif ~strcmp(spin,"")
	if strtod(val) <> 0
		x_sci.graphics.style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch1.svg";
...
x_sci.graphics.in_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0"];
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_ManualSwitch_"  + impl + "_C", 4);
