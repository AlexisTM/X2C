...
public class ConvFnc_Sin2Limiter_FiP8 extends ConversionFunction {
     private static final long serialVersionUID = 1L;

     public ConvFnc_Sin2Limiter_FiP8() throws Exception {
     }
...
// USERCODE-BEGIN:ConvFnc                                                                                               
		...
		double Ts = 0;
		int ts_fact;
		final int BITS = 16; /* internal usage of 16 bit variables for higher resolution */
