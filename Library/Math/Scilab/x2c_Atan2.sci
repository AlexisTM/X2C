...
function [x_sci,y_sci,typ_sci] = x2c_Atan2(job, arg1, arg2)

thisBlockData.Library = "Math"
thisBlockData.block_type_name = "Atan2"
thisBlockData.block_xcosfilename = "x2c_Atan2"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Atan2_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=atan(y/x)";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Atan2_"  + impl + "_C", 4);
