...
function [x_sci,y_sci,typ_sci] = x2c_Exp(job, arg1, arg2)

thisBlockData.Library = "Math"
thisBlockData.block_type_name = "Exp"
thisBlockData.block_xcosfilename = "x2c_Exp"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Exp_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=e<sup>u</sup>";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Exp_"  + impl + "_C", 4);
