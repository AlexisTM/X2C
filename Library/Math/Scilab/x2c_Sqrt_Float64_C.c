...
// Computational function for X2C block Sqrt
...
/* */
void x2c_Sqrt_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_Sqrt_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_Sqrt_Float64_C__StateUpdate(scicos_block* block);
static void x2c_Sqrt_Float64_C__Initialization(scicos_block* block);
static void x2c_Sqrt_Float64_C__Ending(scicos_block* block);
...
void x2c_Sqrt_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Sqrt_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Sqrt_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Sqrt_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Sqrt_Float64_C__Ending(block);
            break;
        }
...
static void x2c_Sqrt_Float64_C__set_parameter(scicos_block* block, SQRT_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    SQRT_FLOAT64 *pTSqrt_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTSqrt_Float64 = GetWorkPtrs(block);
}
...
static void x2c_Sqrt_Float64_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTSqrt_Float64 = scicos_malloc(sizeof(SQRT_FLOAT64));
    GetWorkPtrs(block) = pTSqrt_Float64;
    x2c_Sqrt_Float64_C__set_parameter(block, pTSqrt_Float64);

    /* Assignment of inports */
    inport_In_p = GetInPortPtrs(block, 1);
    inport_In = convert_double_to_float64(*inport_In_p);
    pTSqrt_Float64->In = &inport_In;

    /* Assignment of parameter arrays */

    /* Initialization */
    Sqrt_Float64_Init(pTSqrt_Float64);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float64_to_double(pTSqrt_Float64->Out);
}
...
static void x2c_Sqrt_Float64_C__Ending(scicos_block* block) {
    SQRT_FLOAT64 *pTSqrt_Float64;
    pTSqrt_Float64 = GetWorkPtrs(block);
    scicos_free(pTSqrt_Float64);
}


static void x2c_Sqrt_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Sqrt_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Sqrt_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_Sqrt_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    Sqrt_Float64_Update(pTSqrt_Float64);
