...
/* */
void x2c_uSub_Float32_C(scicos_block* block, scicos_flag flag);
static void x2c_uSub_Float32_C__OutputUpdate(scicos_block* block);
static void x2c_uSub_Float32_C__StateUpdate(scicos_block* block);
static void x2c_uSub_Float32_C__Initialization(scicos_block* block);
static void x2c_uSub_Float32_C__Ending(scicos_block* block);
...
void x2c_uSub_Float32_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_uSub_Float32_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_uSub_Float32_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_uSub_Float32_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_uSub_Float32_C__Ending(block);
            break;
        }
...
static void x2c_uSub_Float32_C__set_parameter(scicos_block* block, USUB_FLOAT32 *blockParam) {
    int *paramI;
    double *paramR;
    USUB_FLOAT32 *pTuSub_Float32;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTuSub_Float32 = GetWorkPtrs(block);
}
...
static void x2c_uSub_Float32_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTuSub_Float32 = scicos_malloc(sizeof(USUB_FLOAT32));
    GetWorkPtrs(block) = pTuSub_Float32;
    x2c_uSub_Float32_C__set_parameter(block, pTuSub_Float32);

    /* Assignment of inports */
    inport_Plus_p = GetInPortPtrs(block, 1);
    inport_Plus = convert_double_to_float32(*inport_Plus_p);
    pTuSub_Float32->Plus = &inport_Plus;
    inport_Minus_p = GetInPortPtrs(block, 2);
    inport_Minus = convert_double_to_float32(*inport_Minus_p);
    pTuSub_Float32->Minus = &inport_Minus;

    /* Assignment of parameter arrays */

    /* Initialization */
    uSub_Float32_Init(pTuSub_Float32);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float32_to_double(pTuSub_Float32->Out);
}
...
static void x2c_uSub_Float32_C__Ending(scicos_block* block) {
    USUB_FLOAT32 *pTuSub_Float32;
    pTuSub_Float32 = GetWorkPtrs(block);
    scicos_free(pTuSub_Float32);
}


static void x2c_uSub_Float32_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_uSub_Float32_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_uSub_Float32_C__StateUpdate_f(block);
    }
}
...
static void x2c_uSub_Float32_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    uSub_Float32_Update(pTuSub_Float32);
