...
/* */
void x2c_Sqrt_Float32_C(scicos_block* block, scicos_flag flag);
static void x2c_Sqrt_Float32_C__OutputUpdate(scicos_block* block);
static void x2c_Sqrt_Float32_C__StateUpdate(scicos_block* block);
static void x2c_Sqrt_Float32_C__Initialization(scicos_block* block);
static void x2c_Sqrt_Float32_C__Ending(scicos_block* block);
...
void x2c_Sqrt_Float32_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Sqrt_Float32_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Sqrt_Float32_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Sqrt_Float32_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Sqrt_Float32_C__Ending(block);
            break;
        }
...
static void x2c_Sqrt_Float32_C__set_parameter(scicos_block* block, SQRT_FLOAT32 *blockParam) {
    int *paramI;
    double *paramR;
    SQRT_FLOAT32 *pTSqrt_Float32;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTSqrt_Float32 = GetWorkPtrs(block);
}
...
static void x2c_Sqrt_Float32_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTSqrt_Float32 = scicos_malloc(sizeof(SQRT_FLOAT32));
    GetWorkPtrs(block) = pTSqrt_Float32;
    x2c_Sqrt_Float32_C__set_parameter(block, pTSqrt_Float32);

    /* Assignment of inports */
    inport_In_p = GetInPortPtrs(block, 1);
    inport_In = convert_double_to_float32(*inport_In_p);
    pTSqrt_Float32->In = &inport_In;

    /* Assignment of parameter arrays */

    /* Initialization */
    Sqrt_Float32_Init(pTSqrt_Float32);

    /* Assignment of outports */
    outport_Out = GetOutPortPtrs(block, 1);
    *outport_Out = convert_float32_to_double(pTSqrt_Float32->Out);
}
...
static void x2c_Sqrt_Float32_C__Ending(scicos_block* block) {
    SQRT_FLOAT32 *pTSqrt_Float32;
    pTSqrt_Float32 = GetWorkPtrs(block);
    scicos_free(pTSqrt_Float32);
}


static void x2c_Sqrt_Float32_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Sqrt_Float32_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Sqrt_Float32_C__StateUpdate_f(block);
    }
}
...
static void x2c_Sqrt_Float32_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    Sqrt_Float32_Update(pTSqrt_Float32);
