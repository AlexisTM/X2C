...
function [x_sci,y_sci,typ_sci] = x2c_Sin(job, arg1, arg2)

thisBlockData.Library = "Math"
thisBlockData.block_type_name = "Sin"
thisBlockData.block_xcosfilename = "x2c_Sin"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Sin_"  + impl + "_C", 4);
...
x_sci.graphics.style = "noLabel=0;displayedLabel=sin(u)";
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Sin_"  + impl + "_C", 4);
