...
/* */
void x2c_Add_Float32_C(scicos_block* block, scicos_flag flag);
static void x2c_Add_Float32_C__OutputUpdate(scicos_block* block);
static void x2c_Add_Float32_C__StateUpdate(scicos_block* block);
static void x2c_Add_Float32_C__Initialization(scicos_block* block);
static void x2c_Add_Float32_C__Ending(scicos_block* block);
...
void x2c_Add_Float32_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Add_Float32_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Add_Float32_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Add_Float32_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Add_Float32_C__Ending(block);
            break;
        }
...
static void x2c_Add_Float32_C__set_parameter(scicos_block* block, ADD_FLOAT32 *blockParam) {
    int *paramI;
    double *paramR;
    ADD_FLOAT32 *pTAdd_Float32;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTAdd_Float32 = GetWorkPtrs(block);
}
...
static void x2c_Add_Float32_C__Ending(scicos_block* block) {
    ADD_FLOAT32 *pTAdd_Float32;
    pTAdd_Float32 = GetWorkPtrs(block);
    scicos_free(pTAdd_Float32);
}


static void x2c_Add_Float32_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Add_Float32_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Add_Float32_C__StateUpdate_f(block);
    }
}
...
static void x2c_Add_Float32_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    Add_Float32_Update(pTAdd_Float32);
